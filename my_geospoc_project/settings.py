"""
Django settings for my_geospoc_project project.
...
SECRET_KEY = '+2$c^or20_xhiqzf*mlgw22yqz5-5qu*^$_^1)fa1lu++y(auu'
...
ROOT_URLCONF = 'my_geospoc_project.urls'
...
WSGI_APPLICATION = 'my_geospoc_project.wsgi.application'
